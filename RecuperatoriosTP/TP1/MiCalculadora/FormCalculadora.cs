...
namespace MiCalculadora
{
    public partial class FormCalculadora : Form
    {
        ...
        private void btnOperar_Click(object sender, EventArgs e)
        {
            ...
            lblResultado.Text = Calculadora.Operar(numero1, numero2, operador[0]).ToString();
            StringBuilder operaciones = new StringBuilder();
            lstOperaciones.Items.Insert(0, operaciones.AppendLine($"{txtNumero1.Text} {operador[0]} {txtNumero2.Text} = {lblResultado.Text}"));
        }
